...
entry_points = '''
[pygments.lexers]
lconflexer = python_lconf_lexer.lexer:LCONFLexer
'''
...
# ===========================================================================================================================
setup(
   name='python_lconf_lexer',
   version=_version,
   author='peter1000',
   author_email='https://github.com/peter1000',
   url='https://github.com/LCONF/python_lconf_lexer',
   ...
   keywords='python pygments lexer sphinx syntax highlighting lconf',
